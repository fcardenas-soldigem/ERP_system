...
const ClientesConConsulta = () => {
  ...
  const handleInputChange = (e) => {
    ...
    // Limpiar datos de consulta si se cambia el documento
            ...
            <Tr key={cliente.id} _hover={{ bg: "gray.50" }}>
              ...
              <Td>
                <Box
                  ...
                  fontWeight="bold"
                  borderRadius="md"
                  bg={cliente.tipo_documento === 'dni' ? 'blue.100' : 'purple.100'}
                  color={cliente.tipo_documento === 'dni' ? 'blue.800' : 'purple.800'}
                >
              ...
              <Td>
                <Box
                  ...
                  fontWeight="bold"
                  borderRadius="md"
                  bg={cliente.activo ? 'green.100' : 'red.100'}
                  color={cliente.activo ? 'green.800' : 'red.800'}
                >
                  ...
                  <Alert status="success" borderRadius="md">
                    ...
                    <Box>
                      ...
                      {clienteActual.tipo_documento === 'dni' ? (
                        <Box fontSize="sm">
                          <div><strong>Nombres:</strong> {datosConsulta.nombres}</div>
                          <div><strong>Apellidos:</strong> {datosConsulta.apellido_paterno} {datosConsulta.apellido_materno}</div>
                        </Box>
                      ) : (
                        <Box fontSize="sm">
                          <div><strong>Razón Social:</strong> {datosConsulta.razon_social}</div>
                          <div><strong>Estado:</strong> {datosConsulta.estado}</div>
                          <div><strong>Condición:</strong> {datosConsulta.condicion}</div>
                        </Box>
                      )}
                    </Box>
                  </Alert>
...
export default ClientesConConsulta; 